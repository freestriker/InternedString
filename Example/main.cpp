...
{
    std::cout << "The test was performed using " << (MAX_STRING_SIZE - MIN_STRING_SIZE) * PER_SIZE_STRING_COUNT << " randomly generated strings ranging in length from " << MIN_STRING_SIZE << " to " << MAX_STRING_SIZE << "." << std::endl << std::endl;
